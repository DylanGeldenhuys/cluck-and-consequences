  ...
  return (
    <Sidebar className="border-r border-border glass-panel">
      <div className="p-4 border-b border-border">
        <NavLink to="/">
          <div className="w-full py-3 px-3 rounded-lg flex items-center justify-center bg-primary/15 hover:bg-primary/20 border-2 border-primary/40 hover:border-primary shadow-lg shadow-primary/20 transition-all cursor-pointer group">
            {!isCollapsed ? (
              <img 
                src={optibroilerLogo} 
                alt="OptiBroiler" 
